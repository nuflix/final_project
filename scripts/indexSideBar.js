...
function makeDiv(arr){
  ...
  document.getElementsByClassName("best-sidebar-item")[1].getElementsByClassName("invisible")[0].innerHTML = JSON.stringify(arr[1]);
  document.getElementsByClassName("best-sidebar-item")[2].getElementsByClassName("invisible")[0].innerHTML = JSON.stringify(arr[2]);
