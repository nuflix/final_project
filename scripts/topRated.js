...
function apiTopRated(x){
    fetch(`https://api.bestbuy.com/v1/products?format=json&show=sku,image,name,customerReviewAverage,customerReviewCount,regularPrice,longDescription,salePrice&pageSize=3&page=${x}&sort=customerReviewAverage.desc&apiKey=IcvHwuaZZxwGBTQF0z3zXAcI`)
    .then((response) => {
